...
func TestRoutes(t *testing.T) {
	...
	cases := []struct {
		...
		{"/en/", http.StatusOK, `class="hero"`},
		{"/en/", http.StatusOK, "What we are working on"},
		{"/en/", http.StatusOK, "Recent posts"},
		{"/static/img/logo.svg", http.StatusOK, "<svg"},
		{"/static/favicon.svg", http.StatusOK, "<svg"},
		{"/de/", http.StatusOK, "Mods und Server"},
		{"/ru/", http.StatusOK, "моды и серверы"},
		{"/de/about", http.StatusOK, "Über uns"},
		{"/ru/about", http.StatusOK, "О проекте"},
		{"/en/about", http.StatusOK, "Preserve My Games"},
		{"/en/privacy", http.StatusOK, "Privacy"},
		{"/en/contact", http.StatusOK, constants.ContactEmail},
		{"/en/donate", http.StatusOK, constants.DonateMonero},
